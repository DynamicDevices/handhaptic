...
func _ready():
	...
	#handmaterials.get_node("handleft" if islefthand else "handright").get_surface_material(0).duplicate()
...
func addfingerpinchbutton(bname):
	...
	var fingerpinchbutton = load("res://FingerPinchButton.tscn").instance()
